...
DEFINE_string(document_root, "", "Document root of the webserver");
...
int main(int argc, char* argv[]) {
  ...
  // Change current directory, not sure if is the best approach
  if (fs::exists(FLAGS_document_root))  {
    fs::current_path(FLAGS_document_root);
  }
